...
# A = P*(1+r/n)**(n*t)
annuity = principal*(1+(rate/100)/compound_frequency)**(compound_frequency*length_of_investment)

annuity = round(annuity,2)

print('The total amount after ' + str(length_of_investment) + ' years is : $'+str(annuity))
