...
def calc_stock_apr(stock):
    ...
    print("The APR over the last 5 years was: " +str(float(round(rate*100,2)))+"%") # multiplies the result of rate by 100 to get percentage and rounds to 2 decimal places
    return
...
def calc_annuity():
    ...
    print("If you had invested $100 a month for 5 years you would have: $" + str(round(annuity*100,2))) # multiply annuity result by 100 for proper decimal placement and rounds the result from annuity to 2 decimal places

tsla()
spy()
aapl()
ntdoy()
calc_stock_apr(ntdoy())
calc_annuity()
